        ...
        <div className="container">
          <Fade top>
            ...
            >
              ...
              <p>
                At Gonje, we invite you to become a valued member of our
                thriving ecommerce community. <br />
                Whether you're a customer, vendor, or supplier, we provide a
                platform that <br />
                empowers you to connect, grow, and succeed in the digital
                marketplace.
              </p>
            </div>
          </Fade>
                ...
                >
                  <div className="products-otr customer-become become-title">
                    ...
                    <p className="become-spacing">
                      <a className="bttn" onClick={openModalCustomer}>
                        Learn more
                      </a>
                    </p>
                  </div>
              ...
              <Fade bottom>
                ...
                >
                  <div className="products-otr vendor-become  become-title">
                    ...
                    <p className="become-spacing">
                      <a className="bttn" onClick={openModalVendor}>
                        Learn more
                      </a>
                    </p>
                  </div>
              ...
              <Fade top>
                ...
                >
                  <div className="products-otr supplier-become become-title">
                    ...
                    <p className="become-spacing">
                      <a className="bttn" onClick={openModalSupplier}>
                        Learn more
                      </a>
                    </p>
                  </div>
